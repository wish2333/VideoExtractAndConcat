...
### 合并视频-输入文件（ffmpegApi.py）

相比之前的代码（20240506），额外接收分辨率和帧率参数
...
## Pyside界面与逻辑代码绑定-20240513（main.py）
...
### Interface模块-添加了多线程和后台任务的部分

必须给子界面设置全局唯一的对象名，才能使得FluentWindow能够显示不同Interface
...
### Interface模块其他设置参照20240506

## Pyside界面与逻辑代码绑定-20240506（main.py）
